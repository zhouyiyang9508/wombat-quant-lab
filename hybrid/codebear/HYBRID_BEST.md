...
|---|---|---|---|---|---|
| v3 (w=20%) | 🚨 有前瞻(bug) | 52.3% | -22.1% | 2.11 | 0.609 |
| v3 (w=20%) | ✅ 修复后 | **47.2%** | -22.1% | 1.92 | **0.612** |
| v5-D (w=20%) | 🚨 有前瞻(bug) | 55.8% | -22.1% | 1.99 | 0.649 |
| v5-D (w=20%) | ✅ 修复后 | **48.3%** | -22.1% | 1.74 | **0.640** |
| v5-D (w=25%) | 🚨 有前瞻(bug) | 61.4% | -21.4% | 1.99 | 0.650 |
| v5-D (w=25%) | ✅ 修复后 | **51.7%** | -25.1% | 1.70 | **0.635** |

### 修复后结论

v5-D **仍优于 v3**（独立 MA 过滤的改进是真实的）：
- CAGR: v5-D(w=20%) 48.3% > v3(w=20%) 47.2%
- WF:   v5-D(w=20%) 0.640 > v3(w=20%) 0.612

...
> Updated: 2026-02-22 by 代码熊 🐻 (v11a突破2.16 🚨 / v10d日频审计)
...
> 
> ⭐ **策略选择指南**:
> - 🏆 **NEW CHAMP**: v11a (Composite **2.160**, WF 0.74, WF3=**0.82**) — 三大创新叠加，首破2.15！MaxDD首次<-9.5%!
> - 上代冠军: v10d (Composite 2.107, WF 0.77) — 日频审计通过 (<25%)
> - 最稳健(WF): v9j (2.057, WF 0.78) — 最高WF，保守选择
> - ⚠️ 日频MaxDD警告: 月频低估2.38x (v10d: 月-10%→日-23.8%; 策略日频MaxDD均<25%)

| Rank | Strategy | CAGR | MaxDD | Sharpe | Calmar | Composite | WF | WF3 | Notes |
|------|----------|------|-------|--------|--------|-----------|-----|-----|-------|
| 🥇1 | **Stock v11a🆕 MasterStack** 🏆 | 31.7% | **-9.5%** | **1.91** | **3.33** | **2.160** | ✅ 0.74 | **0.82** | **首破2.15!MaxDD<10%!** |
...
|------|-----------|------|------|------|
| Composite | 2.057 | 2.107 | **2.160** | 历史最高 |
